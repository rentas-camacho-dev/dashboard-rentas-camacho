...
/* Espacio superior para que el título NO quede debajo del menú */
.block-container {
    max-width: 100%;
...
<td class="num" style="color:{color_flujo};">
{compacto(flujo)}
</td>
...
<td class="num" style="color:#00875A;">
    ...
    if not gastos.empty:
        ...
        with st.container(
            ...
            with gc2:
                ...
                # IMPORTANTE:
                # st.html evita que Streamlit interprete
                # el HTML como código Markdown.
