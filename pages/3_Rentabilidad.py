...
def mostrar_html(html):
    """
    Limpia la indentación de cada línea para evitar que
    Streamlit interprete el HTML como bloque de código.
    """
    html_limpio = "\n".join(
        linea.strip()
